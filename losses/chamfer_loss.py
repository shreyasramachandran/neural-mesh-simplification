...
class ChamferLoss(nn.Module):
    ...
    def forward(self, points1, points2):
        ...
        curvatures1 = self.calculate_curvature(
            points1, k_neighbors=self.k_neighbors)  # Shape: (B, N)

        # Apply curvature weights using Gaussian smoothing
        smoothed_curvatures = self.calculate_smoothed_curvatures(
            points1, curvatures1, self.h)
    ...
    def calculate_curvature(self, points, k_neighbors):
        """
    ...
    def calculate_smoothed_curvatures(self,points1, curvatures1, h):
        """
